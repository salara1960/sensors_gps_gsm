    ...
    if ($_POST["main_bt"] == "SUBMIT") {
        ...
        if ($shm_id > 0) {
            ...
            if ($wr_data_temp != "") {
                ...
                else if ($wr_data_temp == "cmd02") $wrt = chr(68);
                else if ($wr_data_temp == "cmd03") $wrt = chr(190);
                if ($wrt != "") {
                    $pst = 1;
            ...
            if ($sel_temp_adc_chan != "") {
                ...
                else if ($sel_temp_adc_chan == "chan1") $wrt = chr(1);
                else if ($sel_temp_adc_chan == "chan2") $wrt = chr(2);
                else if ($sel_temp_adc_chan == "chan3") $wrt = chr(3);
                if ($wrt != "?") {
                    $pst = 1;
            ...
            if ($pst == 1) {
                ...
                while ($waits) {
                    ...
                    if ($dataready == "11") $waits = 0; else if ($j >= 5) $waits = 0;
                }
