...
<script>
function rkchk(VALUE) {
    var uri='atnum.php?rk='+VALUE;
...
<form name="AT_command" onsubmit="return validate_form_1(this)" method="post" action="./ats.php"  enctype="application/x-www-form-urlencoded" style="margin:0px; height:420px;">
